...
$LIPO -create $pwd/output/x86_64/libmoshcrypto.a $pwd/output/i386/libmoshcrypto.a -output $pwd/output/libmoshcrypto.a
LIPO=$(xcrun -sdk iphoneos -find lipo)
$LIPO -create $pwd/output/x86_64/libmoshnetwork.a $pwd/output/i386/libmoshnetwork.a -output $pwd/output/libmoshnetwork.a
LIPO=$(xcrun -sdk iphoneos -find lipo)
$LIPO -create $pwd/output/x86_64/libmoshprotos.a $pwd/output/i386/libmoshprotos.a -output $pwd/output/libmoshprotos.a
LIPO=$(xcrun -sdk iphoneos -find lipo)
$LIPO -create $pwd/output/x86_64/libmoshios.a $pwd/output/i386/libmoshios.a -output $pwd/output/libmoshios.a
LIPO=$(xcrun -sdk iphoneos -find lipo)
$LIPO -create $pwd/output/x86_64/libmoshstatesync.a $pwd/output/i386/libmoshstatesync.a -output $pwd/output/libmoshstatesync.a
LIPO=$(xcrun -sdk iphoneos -find lipo)
$LIPO -create $pwd/output/x86_64/libmoshterminal.a $pwd/output/i386/libmoshterminal.a -output $pwd/output/libmoshterminal.a
LIPO=$(xcrun -sdk iphoneos -find lipo)
$LIPO -create $pwd/output/x86_64/libmoshutil.a $pwd/output/i386/libmoshutil.a -output $pwd/output/libmoshutil.a
