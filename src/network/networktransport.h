...
public:
  ...
  std::list<TimestampedState<RemoteState>> get_received_states( void ) { return received_states; }
  std::list<TimestampedState<MyState>> get_sent_states( void ) { return sender.get_sent_states(); };
